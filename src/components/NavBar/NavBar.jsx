      ...
      <nav>
        <div className="nav-wrapper">
          ...
          <ul id="nav-mobile" className="right">
            ...
            <li><a href="/albums"><i className="material-icons left small">album</i></a></li>
            <li><a className="nav-link-b" href="/albums/add">Add an Album</a></li>
            <li><a href="/albums/add"><i className="material-icons left small">add album</i></a></li>
            <li><a className="nav-link-a" href="/songs">All Songs</a></li>
            <li><a href="/songs"><i className="material-icons left small">song</i></a></li>
            <li><a className="nav-link-b" href="/songs/add">Add a Song</a></li>
            <li><a href="/songs/add"><i className="material-icons left small">add song</i></a></li>
    ...
    :
      <nav>
        <div className="nav-wrapper">
          <a className=" left" href="/"><img src="https://fontmeme.com/permalink/200705/e2371cf438042048aa22fb9341eadbba.png" height='66' alt="netflix-font" border="0"/></a>
          <ul id="nav-mobile" className="right">
            <li><a className="nav-link" href="/movies">All Albums</a></li>
            <li><a href="/albums"><i className="material-icons left small">Album</i></a></li>
